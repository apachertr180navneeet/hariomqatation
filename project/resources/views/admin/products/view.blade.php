...
<div class="page-header">
    ...
    <div class="d-flex gap-2">
        ...
        <a href="{{ route('product.details') }}?id=PROD-1001" target="_blank" id="btn-view-in-store" class="btn btn-outline-secondary">
    ...
    <div class="col-lg-4">
        <div class="admin-card p-4 mb-4">
            ...
            <div class="d-grid gap-2">
                <a href="{{ route('admin.inventory') }}" class="btn btn-outline-primary btn-sm">
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const id = urlParams.get("id") || "{{ $productId ?? 'PROD-1002' }}";
