...
<div class="page-header">
    <div>
        ...
        <div class="page-breadcrumb">
            <a href="{{ route('admin.dashboard') }}">Dashboard</a> &bull; <span>All Price Quotations (HOC/QTN/2026/XXXX)</span>
        </div>
    </div>
    <div class="d-flex gap-2">
        <a href="{{ route('admin.quotations.create') }}" class="btn btn-primary fw-bold shadow-sm">
        ...
        <div class="row g-3 align-items-center">
            ...
            <div class="col-md-4 text-md-end">
                <span class="badge bg-light text-dark border p-2 small">
                    <i class="bi bi-info-circle text-primary me-1"></i> Workflow: Pending &rarr; Approved &rarr; Convert to Sale
                </span>
            </div>
        </div>
    </div>
