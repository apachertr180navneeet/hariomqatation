...
<body class="bg-secondary bg-opacity-10 py-4">
    ...
    <div class="container mb-3 no-print" style="max-width: 210mm;">
        <div class="card border-0 shadow-sm p-3 d-flex flex-row justify-content-between align-items-center rounded-3 bg-white">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('admin.sales') }}" class="btn btn-outline-secondary">Back to Sales</a>
            </div>
        </div>
    </div>
        ...
        <div class="row g-2 mb-3">
            <div class="col-6">
                <div class="info-box h-100">
                    ...
                    <div class="text-success fw-bold">&check; Amount Received in Full</div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const invId = urlParams.get("id") || "{{ $invoiceId ?? 'HOC/INV/2026/0001' }}";
