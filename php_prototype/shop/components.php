<?php
$pageTitle = "Genuine Computer Components | Hari Om Computer (Jodhpur)";
...
<!-- Page Breadcrumbs -->
  <div class="bg-white border-bottom py-3">
    <div class="container d-flex justify-content-between align-items-center flex-wrap gap-2">
      ...
      <a href="pc-builder.php" class="btn btn-sm btn-primary fw-bold"><i class="bi bi-motherboard me-1"></i> Open PC Builder Tool</a>
    </div>
  </div>
