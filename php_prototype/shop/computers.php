<?php
$pageTitle = "Desktop PCs & Custom Rigs | Hari Om Computer (Jodhpur)";
    ...
    <div class="container">
      <div class="row align-items-center gy-3">
        ...
        <div class="col-lg-4 text-lg-end">
          <a href="pc-builder.php" class="btn btn-primary btn-lg fw-bold"><i class="bi bi-motherboard me-1"></i> Build Custom PC</a>
        </div>
      </div>
    </div>
  </div>
              ...
              <div class="row g-0 h-100">
                ...
                <div class="col-md-7 d-flex flex-column">
                  <div class="product-body-v3">
                    ...
                    <a href="product-details.php?id=${p.id}" class="product-title fs-5">${p.name}</a>
                    ...
                    <div class="product-pricing">
                      ...
                      <div class="d-flex gap-2">
                        ...
                        <a href="product-details.php?id=${p.id}" class="btn btn-outline-secondary btn-sm">Details</a>
                      </div>
                    </div>
                  </div>
                </div>
