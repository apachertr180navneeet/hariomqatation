    ...
    <div class="row g-4">
      ...
      <div class="col-lg-3">
        <div class="card border-0 shadow-sm p-3 mb-4 rounded-3">
          ...
          <div class="mb-3">
            ...
            <div class="position-relative">
              <input type="text" id="filter-search-kw" class="form-control form-control-sm" placeholder="e.g. RTX 4060, i5, Dell...">
            </div>
          </div>
          ...
          <!-- Price Range Filter -->
          <div class="mb-3">
            <label class="form-label small fw-bold">Price Bracket</label>
        ...
        <div class="p-3 rounded-3 text-white" style="background: linear-gradient(135deg, #0284c7 0%, #0f172a 100%);">
          ...
          <a href="pc-builder.php" class="btn btn-sm btn-light w-100 fw-bold">Build Your PC Now</a>
        </div>
      </div>
      ...
      <div class="col-lg-9">
        <div class="d-flex justify-content-between align-items-center mb-3 bg-white p-3 rounded-3 shadow-sm">
          ...
          <div class="d-flex align-items-center gap-2">
            <label class="small text-muted mb-0 d-none d-sm-inline">Sort by:</label>
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
      ...
      if (initialCat) {
        document.getElementById("filter-category").value = initialCat;
      }
      if (initialSearch) {
      ...
      function renderList() {
        ...
        let filtered = allProducts.filter(p => {
          ...
          const matchesCat = cat === "ALL" || p.category.toLowerCase().includes(cat.toLowerCase());
            ...
            <div class="col-md-6 col-lg-4">
              <div class="product-card-v3">
                ...
                <div class="product-body-v3">
                  ...
                  <a href="product-details.php?id=${p.id}" class="product-title" title="${p.name}">${p.name}</a>
