      ...
      <div class="page-header">
        <div>
          ...
          <div class="page-breadcrumb">
            <a href="dashboard.php">Hari Om Computer</a> &bull; <span>Live Sales & Quotation Overview</span>
          </div>
        </div>
        <div class="d-flex gap-2">
          <a href="quotation-create.php" class="btn btn-primary fw-semibold shadow-sm">
            <i class="bi bi-plus-lg me-1"></i> Create Quotation
          </a>
          <a href="pc-builder.php" class="btn btn-outline-primary fw-semibold">
        ...
        <div class="col-lg-4">
          <div class="admin-card mb-0">
            <div class="admin-card-header">
              ...
              <a href="inventory.php" class="btn btn-sm btn-outline-secondary">Inventory</a>
            </div>
            <div class="table-responsive">
