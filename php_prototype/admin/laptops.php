...
<div class="page-header">
        <div>
          ...
          <div class="page-breadcrumb"><a href="dashboard.php">Dashboard</a> &bull; <span>Dedicated Laptop Specifications</span></div>
        </div>
      </div>
      ...
      laptops.forEach(p => {
        html += `
          <tr>
            ...
            <td class="text-end">
              <a href="product-view.php?id=${p.id}" class="btn btn-sm btn-outline-secondary"><i class="bi bi-eye"></i></a>
            </td>
          </tr>
        `;
      });
