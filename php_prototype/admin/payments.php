...
<div class="page-header">
        <div>
          ...
          <div class="page-breadcrumb"><a href="dashboard.php">Dashboard</a> &bull; <span>Cash, UPI, NEFT & Cheques</span></div>
        </div>
      </div>
      ...
      payments.forEach(p => {
        html += `
          <tr>
            ...
            <td><a href="invoice-view.php?id=${encodeURIComponent(p.invoiceNo)}" class="text-dark fw-semibold">${p.invoiceNo}</a></td>
