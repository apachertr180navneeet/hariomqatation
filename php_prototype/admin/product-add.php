...
<div class="page-header">
        <div>
          ...
          <div class="page-breadcrumb"><a href="products.php">Products</a> &bull; <span>New Hardware SKU</span></div>
        </div>
      </div>
      ...
      <form id="add-product-form" onsubmit="event.preventDefault(); saveNewProduct();">
        ...
        <div class="d-flex gap-3">
          ...
          <a href="products.php" class="btn btn-outline-secondary py-2">Cancel</a>
        </div>
      </form>
