<?php
$pageTitle = "Products Management | Hari Om Computer ERP";
...
<div class="page-header">
        <div>
          ...
          <div class="page-breadcrumb"><a href="dashboard.php">Dashboard</a> &bull; <span>Catalog & Pricing</span></div>
        </div>
        <div>
          <a href="product-add.php" class="btn btn-primary fw-semibold"><i class="bi bi-plus-lg me-1"></i> Add Product</a>
        </div>
      </div>
