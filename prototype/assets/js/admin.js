    ...
    if (recentQuotesTbody) {
      ...
      quotes.slice(0, 5).forEach(q => {
        ...
        html += `
          <tr>
            <td>
              <a href="quotation-view.html?id=${encodeURIComponent(q.id)}" class="fw-bold text-primary text-decoration-none">
                ${q.id}
              </a>
            </td>
            <td>
            ...
            <td>
              <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                  <li><a class="dropdown-item" href="quotation-view.html?id=${encodeURIComponent(q.id)}"><i class="bi bi-eye text-primary me-2"></i>View Quotation</a></li>
                  <li><a class="dropdown-item" href="quotation-print.html?id=${encodeURIComponent(q.id)}" target="_blank"><i class="bi bi-printer text-dark me-2"></i>Print / PDF</a></li>
        ...
        lowItems.slice(0, 5).forEach(p => {
          html += `
            <tr>
              ...
              <td>
                <a href="inventory.html" class="btn btn-xs btn-outline-primary py-1 px-2 text-xs">
          ...
          <tr>
            ...
            <td class="text-end">
              <div class="btn-group btn-group-sm">
                <a href="quotation-view.html?id=${encodeURIComponent(q.id)}" class="btn btn-outline-secondary" title="View Details">
                  <i class="bi bi-eye"></i>
                </a>
                <a href="quotation-print.html?id=${encodeURIComponent(q.id)}" target="_blank" class="btn btn-outline-primary" title="Print / PDF">
          ...
          <tr>
            <td>
              <div class="d-flex align-items-center gap-3">
                ...
                <div>
                  <a href="product-view.html?id=${p.id}" class="fw-bold text-dark text-decoration-none d-block">${p.name}</a>
            ...
            <td class="text-end">
              <div class="btn-group btn-group-sm">
                <a href="product-view.html?id=${p.id}" class="btn btn-outline-secondary" title="View"><i class="bi bi-eye"></i></a>
